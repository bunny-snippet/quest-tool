(() => {
  ...
  function openIntegration(clientId, integrationId = null) {
    ...
    edit.integrationClient = Number(clientId); edit.integration = integrationId ? Number(integrationId) : null; integrationForm.reset(); integrationForm.elements.is_active.checked = true; integrationForm.elements.enforce_local_targeting.checked = true; integrationForm.elements.sync_interval_seconds.value = 600;
