(() => {
  ...
  const filterDefaults = { country: 'All countries', status: 'All statuses', company: 'All companies', client_name: 'All clients' };
  ...
  function queryString() {
    const params = new URLSearchParams({ page: state.page, page_size: state.pageSize, ordering: '-source_modified_at' });
