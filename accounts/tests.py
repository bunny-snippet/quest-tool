...
class FunctionAccessTests(TestCase):
    ...
    def test_super_admin_can_crud_role_permissions(self):
        ...
        self.assertContains(page, "studies.field.provider_status")
        self.assertContains(page, "studies.field.status_source")
        self.assertContains(page, "studies.filter.supplier")
        ...
        self.assertContains(page, "termination_reasons.table.provider_status")
        self.assertContains(page, "termination_reasons.table.reason")
        self.assertContains(page, "termination_reasons.export.status_source")
        self.assertContains(page, "organization.card.client_grants")
        # Legacy supplier quantity controls are intentionally retired and must
        # not return to the grantable catalog.
