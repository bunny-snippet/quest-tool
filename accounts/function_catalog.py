...
FUNCTION_CATALOG = (
    ...
    ("prescreener_data.view", "View Prescreened Data page and sidebar", "Prescreened Data - Page & navigation", "Open the isolated pre-screener submission vault.", ADMIN_ROLES),
    ("prescreener_data.filter.search", "Search UID or RID", "Prescreened Data - Filters", "Search vault submissions by internal UID or respondent RID.", ADMIN_ROLES),
    ("prescreener_data.filter.country", "Filter by country", "Prescreened Data - Filters", "Filter pre-screening submissions by captured country.", ADMIN_ROLES),
    ("prescreener_data.filter.language", "Filter by language", "Prescreened Data - Filters", "Filter pre-screening submissions by captured survey language.", ADMIN_ROLES),
    ("prescreener_data.filter.age_group", "Filter by age group", "Prescreened Data - Filters", "Filter submissions by normalized respondent age group.", ADMIN_ROLES),
    ("prescreener_data.filter.gender", "Filter by gender", "Prescreened Data - Filters", "Filter submissions by normalized respondent gender.", ADMIN_ROLES),
    ("prescreener_data.filters.clear", "Clear Prescreened Data filters", "Prescreened Data - Filters", "Clear all vault filters.", ADMIN_ROLES),
    ("prescreener_data.export", "Export Prescreened Data workbook", "Prescreened Data - Actions", "Export every filtered submission and its linked answers as a formatted Excel workbook.", ADMIN_ROLES),
    ("prescreener_data.control.pagination", "Use vault pagination", "Prescreened Data - Page controls", "Move between pages of vault submissions.", ADMIN_ROLES),
    ("prescreener_data.column.uid", "Show UID and RID column", "Prescreened Data - Table columns", "Display the immutable submission UID and respondent RID.", ADMIN_ROLES),
    ...
    ("termination_reasons.filter.rid", "Search by RID", "Term Reports - Filters", "Filter final unsuccessful survey attempts by respondent RID.", ADMIN_ROLES),
    ...
    ("vendors.card.quantity", "Show Available quantity card", "Supplier Management - Summary cards", "Display remaining allocated quantity.", ("super-admin",)),
    ...
    ("vendors.column.client.quantity", "Show Quantity column", "Supplier Management - Client allocation columns", "Display client capacity usage.", ("super-admin",)),
    ...
    ("vendors.column.project.quantity", "Show Quantity column", "Supplier Management - Project allocation columns", "Display project capacity usage.", ("super-admin",)),
