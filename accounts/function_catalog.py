...
FUNCTION_CATALOG = (
    ...
    ("studies.filter.client", "Use Client filter", "Studies - Filters", "Filter Studies by one or more clients.", TRACKING_ROLES),
    ("studies.filter.buyer", "Use Sub-client / Buyer ID filter", "Studies - Filters", "Filter Studies by provider buyer/sub-client identifiers.", TRACKING_ROLES),
    ("studies.filter.project", "Use Project deep-link filter", "Studies - Filters", "Open Studies scoped to one Project ID from the Projects table.", TRACKING_ROLES),
    ...
    ("studies.column.country", "Show Country column", "Studies - Table columns", "Display the survey country captured through the related project.", TRACKING_ROLES),
    ("studies.column.cpi", "Show snapshot CPI column", "Studies - Table columns", "Display the CPI frozen when the respondent hit the survey.", TRACKING_ROLES),
    ...
    ("studies.card.total", "Show Total hits card", "Studies - Summary cards", "Display the filtered study hit total.", TRACKING_ROLES),
    ("studies.card.initiated", "Show Initiated card", "Studies - Summary cards", "Display initiated study journeys.", TRACKING_ROLES),
    ("studies.card.completed", "Show Completed card", "Studies - Summary cards", "Display completed study journeys.", TRACKING_ROLES),
    ("studies.card.terminated", "Show Terminated card", "Studies - Summary cards", "Display terminated study journeys.", TRACKING_ROLES),
    ("studies.card.quota", "Show Quota card", "Studies - Summary cards", "Display over-quota study journeys.", TRACKING_ROLES),
    ("studies.card.security", "Show Security card", "Studies - Summary cards", "Display quality and security terminations.", TRACKING_ROLES),
    ("studies.card.conversion", "Show Conversion card", "Studies - Summary cards", "Display completed-to-hit conversion.", TRACKING_ROLES),
    ("studies.card.desktop", "Show Desktop completes card", "Studies - Summary cards", "Display completed Desktop journeys.", TRACKING_ROLES),
    ...
    ("termination_reasons.filter.status", "Filter by status", "Termination Reasons - Filters", "Filter outcomes by terminated, quota or quality/security status.", ADMIN_ROLES),
    ("termination_reasons.filter.client", "Filter by client", "Termination Reasons - Filters", "Filter provider outcomes by client integration.", ADMIN_ROLES),
    ("termination_reasons.filters.clear", "Clear outcome filters", "Termination Reasons - Filters", "Clear all Termination Reasons list filters.", ADMIN_ROLES),
    ("termination_reasons.card.total", "Show Unsuccessful card", "Termination Reasons - Summary cards", "Display total unsuccessful outcomes.", ADMIN_ROLES),
    ("termination_reasons.card.terminated", "Show Terminated card", "Termination Reasons - Summary cards", "Display terminated outcomes.", ADMIN_ROLES),
    ("termination_reasons.card.quota", "Show Quota full card", "Termination Reasons - Summary cards", "Display quota-full outcomes.", ADMIN_ROLES),
    ("termination_reasons.card.quality", "Show Quality / security card", "Termination Reasons - Summary cards", "Display quality and security outcomes.", ADMIN_ROLES),
    ("termination_reasons.control.pagination", "Use outcome pagination", "Termination Reasons - Page controls", "Move between pages of unsuccessful respondent outcomes.", ADMIN_ROLES),
    ("termination_reasons.action.details", "Open outcome details", "Termination Reasons - Actions", "Open an individual RID's full provider outcome modal.", ADMIN_ROLES),
    ...
    ("termination_reasons.column.rid", "Show RID column", "Termination Reasons - Table columns", "Display the respondent RID.", ADMIN_ROLES),
    ("termination_reasons.column.survey", "Show survey column", "Termination Reasons - Table columns", "Display project and survey identifiers.", ADMIN_ROLES),
    ("termination_reasons.column.client", "Show client column", "Termination Reasons - Table columns", "Display client and provider identity.", ADMIN_ROLES),
    ("termination_reasons.column.respondent", "Show respondent column", "Termination Reasons - Table columns", "Display the associated platform user.", ADMIN_ROLES),
    ("termination_reasons.column.status", "Show status column", "Termination Reasons - Table columns", "Display normalized final status.", ADMIN_ROLES),
    ("termination_reasons.column.ended", "Show ended column", "Termination Reasons - Table columns", "Display callback or final activity time.", ADMIN_ROLES),
    ("termination_reasons.column.actions", "Show detail action column", "Termination Reasons - Table columns", "Display the individual outcome Details action.", ADMIN_ROLES),
    ...
    ("vendors.card.vendors", "Show Vendors card", "Vendor Management - Summary cards", "Display internal and external vendor totals.", ("super-admin",)),
    ("vendors.card.client_grants", "Show Client grants card", "Vendor Management - Summary cards", "Display active vendor-client grants.", ("super-admin",)),
    ("vendors.card.quantity", "Show Available quantity card", "Vendor Management - Summary cards", "Display remaining allocated quantity.", ("super-admin",)),
    ("vendors.card.projects", "Show Allocated projects card", "Vendor Management - Summary cards", "Display project allocation totals.", ("super-admin",)),
