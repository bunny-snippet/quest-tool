...
FUNCTION_CATALOG = (
    ...
    ("studies.filter.supplier", "Use Supplier filter", "Traffic Reports - Filters", "Filter Traffic Reports by one or more external supplier accounts attached to respondent journeys.", TRACKING_ROLES),
    ...
    ("studies.column.pid", "Show PID column", "Traffic Reports - Table columns", "Display the platform's independent per-attempt PID tracking identifier.", TRACKING_ROLES),
    ...
    ("prescreener_data.card.records", "Show Records card", "Panelist Data - Summary cards", "Display the filtered panelist profile count.", ADMIN_ROLES),
    ("prescreener_data.card.countries", "Show Countries card", "Panelist Data - Summary cards", "Display the number of visible countries.", ADMIN_ROLES),
    ("prescreener_data.card.age_groups", "Show Age groups card", "Panelist Data - Summary cards", "Display the number of visible age-group segments.", ADMIN_ROLES),
    ("prescreener_data.card.genders", "Show Genders card", "Panelist Data - Summary cards", "Display the number of captured gender values.", ADMIN_ROLES),
    ...
    ("termination_reasons.filter.supplier", "Filter by supplier", "Term Reports - Filters", "Filter unsuccessful outcomes by one or more external suppliers attached to respondent journeys.", ADMIN_ROLES),
    ...
    ("termination_reasons.column.status", "Show platform status", "Term Reports - Table columns", "Display the normalized platform final status.", ADMIN_ROLES),
    ("termination_reasons.table.provider_status", "Show provider status in table", "Term Reports - Table details", "Display the provider-reported outcome inside each Term Report status cell.", ADMIN_ROLES),
    ("termination_reasons.table.reason", "Show term reason in table", "Term Reports - Table details", "Display the exact provider term reason or category inside each Term Report status cell.", ADMIN_ROLES),
    ("termination_reasons.export.status_source", "Export status source", "Term Reports - Export fields", "Include the internal callback/status source in the Term Reports workbook.", ADMIN_ROLES),
    ...
    ("user_hits.filter.supplier", "Use Supplier filter", "User Hits - Filters", "Filter User Hits by one or more external suppliers attached to respondent journeys.", TRACKING_ROLES),
    ...
    ("allocations.view", "View allocations", "Supplier Management - Page & navigation", "View supplier client grants and project access overrides.", ("super-admin",)),
    ("allocations.manage", "Manage allocations", "Supplier Management - Actions", "Create and update client grants and project access overrides.", ("super-admin",)),
