...
FUNCTION_CATALOG = (
    ...
    ("attempts.export", "Export full Traffic Reports CSV", "Traffic Reports - Actions", "Export complete respondent audit records matching permitted filters.", ("super-admin",)),
