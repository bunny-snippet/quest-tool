...
FUNCTION_CATALOG = (
    ...
    ("termination_reasons.summary", "View outcome totals", "Termination Reasons - Page controls", "Display total, terminated, quota and quality/security summary cards.", ADMIN_ROLES),
